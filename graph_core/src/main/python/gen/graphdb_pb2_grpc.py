...
class ServicesToGraphCoreStub(object):
    ...
    def __init__(self, channel):
        ...
        self.GetTheDataToQueryInNextIteration = channel.unary_unary(
                '/ServicesToGraphCore/GetTheDataToQueryInNextIteration',
                request_serializer=graphdb__pb2.CaseExportStatus.SerializeToString,
                response_deserializer=graphdb__pb2.StringMessage.FromString,
                )
        self.UpdateProcessedTimeToTrackingTableForRawData = channel.unary_unary(
                '/ServicesToGraphCore/UpdateProcessedTimeToTrackingTableForRawData',
                request_serializer=graphdb__pb2.UpdateProcessedTime.SerializeToString,
                response_deserializer=graphdb__pb2.StringMessage.FromString,
                )
        self.UpdateAddedTimeToTrackingTableForRawData = channel.unary_unary(
                '/ServicesToGraphCore/UpdateAddedTimeToTrackingTableForRawData',
                request_serializer=graphdb__pb2.AddAddedTimeForRawData.SerializeToString,
                response_deserializer=graphdb__pb2.StringMessage.FromString,
                )
...
def add_ServicesToGraphCoreServicer_to_server(servicer, server):
    rpc_method_handlers = {
            ...
            'GetTheDataToQueryInNextIteration': grpc.unary_unary_rpc_method_handler(
                    servicer.GetTheDataToQueryInNextIteration,
                    request_deserializer=graphdb__pb2.CaseExportStatus.FromString,
                    response_serializer=graphdb__pb2.StringMessage.SerializeToString,
            ),
            'UpdateProcessedTimeToTrackingTableForRawData': grpc.unary_unary_rpc_method_handler(
                    servicer.UpdateProcessedTimeToTrackingTableForRawData,
                    request_deserializer=graphdb__pb2.UpdateProcessedTime.FromString,
                    response_serializer=graphdb__pb2.StringMessage.SerializeToString,
            ),
            'UpdateAddedTimeToTrackingTableForRawData': grpc.unary_unary_rpc_method_handler(
                    servicer.UpdateAddedTimeToTrackingTableForRawData,
                    request_deserializer=graphdb__pb2.AddAddedTimeForRawData.FromString,
                    response_serializer=graphdb__pb2.StringMessage.SerializeToString,
            ),
    }
    generic_handler = grpc.method_handlers_generic_handler(
...
class ServicesToGraphCore(object):
    ...
    @staticmethod
    def GetTheDataToQueryInNextIteration(request,
            target,
            options=(),
            channel_credentials=None,
            call_credentials=None,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/ServicesToGraphCore/GetTheDataToQueryInNextIteration',
            graphdb__pb2.CaseExportStatus.SerializeToString,
            graphdb__pb2.StringMessage.FromString,
            options, channel_credentials,
            call_credentials, compression, wait_for_ready, timeout, metadata)

    @staticmethod
    def UpdateProcessedTimeToTrackingTableForRawData(request,
            target,
            options=(),
            channel_credentials=None,
            call_credentials=None,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/ServicesToGraphCore/UpdateProcessedTimeToTrackingTableForRawData',
            graphdb__pb2.UpdateProcessedTime.SerializeToString,
            graphdb__pb2.StringMessage.FromString,
            options, channel_credentials,
            call_credentials, compression, wait_for_ready, timeout, metadata)

    @staticmethod
    def UpdateAddedTimeToTrackingTableForRawData(request,
            target,
            options=(),
            channel_credentials=None,
            call_credentials=None,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/ServicesToGraphCore/UpdateAddedTimeToTrackingTableForRawData',
            graphdb__pb2.AddAddedTimeForRawData.SerializeToString,
            graphdb__pb2.StringMessage.FromString,
            options, channel_credentials,
            call_credentials, compression, wait_for_ready, timeout, metadata)
